 ...
 */
public class SomeEntityChangeCEvent extends AbstractSomeEntityChangeEvent {
     ...
     * @param someEntityId
     */
    public SomeEntityChangeCEvent(String oldValue, String newValue, Integer someEntityId) {
