 ...
 */
public class SomeEntityChangeDEvent extends AbstractSomeEntityChangeEvent {
     ...
     * @param someEntityId
     */
    public SomeEntityChangeDEvent(String oldValue, String newValue, Integer someEntityId) {
